...
#
# Build mesakit-examples
#

echo "Cloning mesakit-examples"
cd "$ROOT"
$CLONE https://github.com/Telenav/mesakit-examples.git

echo "Building mesakit-examples"
cd "$ROOT"/mesakit-examples
$BUILD
